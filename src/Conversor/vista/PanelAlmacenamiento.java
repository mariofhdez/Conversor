...
public class PanelAlmacenamiento extends JPanel implements ActionListener {
	...
	private void iniciarComponentes() {
		...
		medidaBase = new JComboBox<String>(new String []{"Byte","KiloByte","MegaByte","GigaByte","TeraByte"});
		medidaDestino = new JComboBox<String>(new String []{"Byte","KiloByte","MegaByte","GigaByte","TeraByte"});
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btnCalcular) {
			...
			if(verificarNumero(input)) {
				...
				String conversion = operacionController.convertirAlmacenamiento(dato,unidad1,unidad2);	
